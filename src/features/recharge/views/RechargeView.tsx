...
export function RechargeView() {
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      <section>
        <h2 className="font-bold text-lg md:text-xl mb-4 md:mb-6 px-2 text-foreground">
          Quick Recharge
        </h2>
      ...
      <section className="space-y-4">
        <div className="bg-card p-6 md:p-8 rounded-[24px] md:rounded-[32px] border border-border shadow-sm space-y-4 md:space-y-6">
